  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        buttonFocus: 'var(--shadow-button-focus)',
      },
      blur: {
        default: 'var(--blur)'
      },
      borderRadius: {
        none: '/* 0px */ var(--border-radius-none)',
        sm: '/* 4px */ var(--border-radius-sm)',
        md: '/* 8px */ var(--border-radius-md)',
        lg: '/* 16px */ var(--border-radius-lg)',
      },
    },
  },
  plugins: [],
